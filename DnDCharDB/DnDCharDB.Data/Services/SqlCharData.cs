...
{
    public class SqlCharData : ICharData
    {
        private Random rng = new Random();
        private readonly CharacterDbContext db;

        public SqlCharData(CharacterDbContext db)
        {
            this.db = db;
        }
        ...
        {
            return from r in db.Characters
                   orderby r.Name
                   select r;
        }
        ...
        {
            return db.Characters.FirstOrDefault(x => x.Id == id);
        }
